...
#
# Worktree acquisition remains outside this adapter: fm-spawn.sh takes a
# durable Treehouse lease, sends the exact leased path through a top-level cd,
# and confirms the pane cwd with these send/current-path primitives.
#
...
# (the leased-worktree cd, the GOTMPDIR export) that already ran this exact sequence
