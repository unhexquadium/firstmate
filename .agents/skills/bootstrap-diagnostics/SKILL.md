...
- `WORKTREE_PROTECTION: task <id>: skipped|failed: <detail>` - the locked post-reboot sweep could not re-establish Treehouse presence protection for that recorded task worktree.
